...
class HeuristicDetector:
    ...
    def should_trigger_complex_process_heuristically(prompt_text: str) -> bool:
        ...
        if any(re.search(keyword, prompt_lower) for keyword in design_architecture_keywords):
            ...
            return True
        if HeuristicDetector._check_architect_pattern(prompt_lower):
        ...
        if HeuristicDetector._check_complex_implementation_pattern(prompt_lower):
